  ...
  return (
    <View className="flex-1 bg-[#0F1113]">
      <View className="flex-row items-center justify-between px-4 py-3 border-b border-white/10">
        ...
        <Text className="text-lg font-bold text-white">Observaciones</Text>
        <View className="w-10" />
      </View>
        ...
        {loading ? (
          ...
          <View className="gap-5">
            {observations.map((record) => (
              ...
              >
                <View
                  className={"absolute inset-x-0 top-0 h-1 bg-teal-500/60"}
                />
                ...
                <View className="bg-white/5 border border-white/10 rounded-2xl p-4">
                  <View className="flex-row items-start gap-2">
                    ...
                    <View className="flex-1">
                      <Text className="text-[10px] font-semibold uppercase tracking-tight text-white/50 mb-2">
                        Observación
                      </Text>
